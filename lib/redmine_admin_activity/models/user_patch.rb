...
module RedmineAdminActivity::Models
  module UserPatch
    ...
    def journalized_attribute_names
      ...
      names |= %w(staff beta_tester instance_manager trusted_api_user) if Redmine::Plugin.installed?(:redmine_scn)
      names
    end

    def create_journal
      if current_journal && current_journal.details.any?
...
class User < Principal
  prepend RedmineAdminActivity::Models::UserPatch
